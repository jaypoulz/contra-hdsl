 ...
 * @param config.linchpin_container_name: a key with a String value which indicates the container name where linchpin
 *                                      will be executed from.
 * @param config.ansible_container_name: a key with a String value which indicates the container name where ansible
 *                                      will be executed from.
 * @return
 */
def call(Map<String, ?> config=[:]) {
    ...
    String linchpinContainerName = config.linchpin_container_name ?: 'linchpin-executor'
    String ansibleContainerName = config.ansible_container_name ?: 'ansible-executor'
